...
//     { id: 'management', name: 'Gestion scolaire', count: 5 },
//     { id: 'trends', name: 'Tendances', count: 5 }
//   ];

//   const blogPosts = [
//     {
//       id: 1,
//       title: "L'avenir de l'éducation numérique : Tendances 2025",
//       excerpt: "Découvrez comment les technologies émergentes transforment l'enseignement et l'apprentissage dans les établissements scolaires modernes.",
//       image: "https://schoolify-edtech.com/wp-content/uploads/2024/10/Capture-decran-2024-10-25-151902-980x444.png 980w, https://schoolify-edtech.com/wp-content/uploads/2024/10/Capture-decran-2024-10-25-151902-480x218.png 480w",
//       author: "Sarah Martinez",
//       date: "15 Nov 2024",
//       readTime: "5 min",
//       category: "education",
//       tags: ["Innovation", "EdTech", "Futur"]
//     },
//     {
//       id: 2,
//       title: "Comment optimiser la communication école-famille avec SCHOOLIFY",
//       excerpt: "Guide pratique pour améliorer l'engagement parental grâce aux outils de communication intégrés de notre plateforme.",
...
//     {
//       id: 3,
//       title: "Intelligence artificielle dans l'éducation : Mythes et réalités",
//       excerpt: "Démystifions l'IA en éducation et explorons ses applications concrètes dans la gestion des établissements scolaires.",
//       image: "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?w=500&h=300&fit=crop",
//       author: "Dr. Emma Laurent",
//       date: "8 Nov 2024",
//       readTime: "6 min",
//       category: "technology",
//       tags: ["IA", "Innovation", "Automatisation"]
//     },
//     {
//       id: 4,
//       title: "Guide complet : Digitaliser son établissement scolaire en 2024",
//       excerpt: "Étapes clés, bonnes pratiques et retours d'expérience pour réussir sa transformation digitale éducative.",
//       image: "https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=500&h=300&fit=crop",
//       author: "Thomas Richard",
//       date: "5 Nov 2024",
//       readTime: "10 min",
//       category: "management",
//       tags: ["Digitalisation", "Transformation", "Guide"]
//     },
//     {
//       id: 5,
//       title: "Cybersécurité dans les écoles : Protéger les données des élèves",
//       excerpt: "Enjeux de sécurité, réglementations RGPD et meilleures pratiques pour sécuriser les systèmes d'information scolaires.",
...
//     {
//       id: 6,
//       title: "Retour d'expérience : Le Lycée Victor Hugo adopte SCHOOLIFY",
//       excerpt: "Témoignage exclusif sur l'implémentation de notre solution et les bénéfices observés après 6 mois d'utilisation.",
//       image: "https://images.unsplash.com/photo-1523240795612-9a054b0db644?w=500&h=300&fit=crop",
//       author: "Marie Dubois",
//       date: "28 Oct 2024",
//       readTime: "4 min",
//       category: "education",
//       tags: ["Témoignage", "Succès", "Lycée"]
//     }
//   ];
...
//       {/* Hero Section */}
//       <div className="relative bg-gradient-to-r from-[#00adee]/10 via-white/50 to-[#1b75bb]/10 py-20">
...
//             Découvrez les dernières tendances en éducation numérique, 
//             guides pratiques et retours d'expérience de nos utilisateurs
//           </p>
//         </div>
//       </div>
...
//           <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-white/50 overflow-hidden hover:shadow-2xl transition-all duration-500 group">
...
//                   <span className="bg-gradient-to-r from-[#00adee] to-[#1b75bb] text-white px-3 py-1 rounded-full text-xs font-semibold uppercase tracking-wide">
...
//                     <div className="w-10 h-10 bg-gradient-to-r from-[#00adee] to-[#1b75bb] rounded-full flex items-center justify-center">
...
//                       <p className="text-sm text-gray-500">{featuredPost.date} • {featuredPost.readTime} de lecture</p>
//                     </div>
//                   </div>
...
//                     ? 'bg-gradient-to-r from-[#00adee] to-[#1b75bb] text-white shadow-lg transform scale-105'
//                     : 'bg-white/80 backdrop-blur-sm text-gray-600 hover:bg-white/90 hover:shadow-md hover:scale-105 border border-white/50'
//                 }`}
//               >
//                 {category.name}
...
//         {/* Grille des articles - Style plus sobre et professionnel */}
...
//                   className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00adee] focus:border-transparent"
//                 />
...
//                         post.category === 'education' ? 'bg-[#00adee]' :
//                         post.category === 'technology' ? 'bg-[#1b75bb]' :
//                         post.category === 'management' ? 'bg-[#fdc500]' :
//                         'bg-gray-600'
//                       }`}>
...
//                       <button className="text-[#00adee] hover:text-[#1b75bb] font-semibold text-sm transition-colors duration-300">
//                         Lire plus →
//                       </button>
//                     </div>
//                   </div>
...
//         <div className="bg-gradient-to-r from-[#00adee] to-[#1b75bb] rounded-3xl p-8 lg:p-12 text-center text-white relative overflow-hidden">
...
//               Recevez notre newsletter mensuelle avec les derniers articles et actualités de SCHOOLIFY
//             </p>
...
//               />
//               <button className="bg-white text-[#00adee] px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors duration-300">
//                 S'abonner
//               </button>
//             </div>
...
//             <button className="px-4 py-2 rounded-lg bg-white/80 backdrop-blur-sm border border-white/50 text-gray-600 hover:bg-white/90 transition-all duration-300">
//               Précédent
//             </button>
...
//                   page === 1
//                     ? 'bg-[#00adee] text-white'
//                     : 'bg-white/80 backdrop-blur-sm border border-white/50 text-gray-600 hover:bg-white/90'
//                 }`}
//               >
//                 {page}
//               </button>
