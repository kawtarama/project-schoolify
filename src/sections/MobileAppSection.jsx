...
import React, { useState } from 'react';
import { Smartphone, BarChart3, MessageSquare, MapPin, Shield } from "lucide-react"; 
import phone from '../assets/phone.png'; // Import de votre photo
    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative flex justify-center lg:justify-start">
            <div className="relative">
              <div className="relative w-[400px] h-[750px] transform hover:scale-105 transition-transform duration-300">
                {!imageError ? (
                  <img
                    src={phone}
                    alt="Application mobile Schoolify"
                  ...
                  <div className="w-full h-full bg-black rounded-[3rem] p-9 shadow-2xl flex items-center justify-center">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 text-lg text-gray-600 leading-relaxed">
              <p>
                Schoolify est un progiciel de gestion et suivi pour l'administration des établissements scolaires 
                et leurs élèves, une solution simple, performante et intuitive.
              </p>
              <p>
                Outil performant qui offre messagerie intégrée, suivi scolaire pour parents/élèves/profs, 
                géolocalisation du transport scolaire en temps réel et notifications instantanées.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 pt-6">
              ...
              <div className="flex items-center space-x-4 p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition">
                <div className="w-12 h-12 flex items-center justify-center rounded-full bg-blue-700">
